...
# for i in range (len(lista_de_listas_de_inteiros) - 1):
#     #print(lista_de_listas_de_inteiros[i])
#     for j in range (len(lista_de_listas_de_inteiros[i]) - 1):
#         #print(lista_de_listas_de_inteiros[i][j])
#         if (lista_de_listas_de_inteiros[i][j]) == (lista_de_listas_de_inteiros[i][j-1]):
#             print(lista_de_listas_de_inteiros[i][j])
